                ...
                <div className="theme-columns is-vertical-center">
                    <div className="theme-column theme-columns__column">
                        <div className="theme-hero-title-content theme-hero-title__content">
                            ...
                            <br/><br/>The new stellarity token is a global, decentralized new generation cryptocurrency which is guaranteed to have a steady and legitimate exchange rate due to money and escrow model received from our partners and investors. 
                            <br/><br/>Don't waste anymore time, and join our community!</p>
